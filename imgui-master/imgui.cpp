...
void ImGui::RenderWindowDecorations(ImGuiWindow* window, const ImRect& title_bar_rect, bool title_bar_is_highlight, int resize_grip_count, const ImU32 resize_grip_col[4], float resize_grip_draw_size)
{
    ...
    else
    {
        ...
        if (!(flags & ImGuiWindowFlags_NoTitleBar))
        {
            ...
            ImU32 title_bar_col_underline1 = GetColorU32(ImVec4(0.180, 0.478, 0.937, 1.000));
            ImU32 title_bar_col_underline2 = GetColorU32(ImVec4(0.180, 0.796, 0.937, 1.000));
            window->DrawList->AddRectFilled(title_bar_rect.Min, title_bar_rect.Max, title_bar_col, window_rounding, ImDrawCornerFlags_Top);
            window->DrawList->AddRectFilledMultiColor(title_bar_rect.Min - ImVec2(0.0f, -22.0f), title_bar_rect.Max, title_bar_col_underline1, title_bar_col_underline2, title_bar_col_underline2, title_bar_col_underline1);
        }
